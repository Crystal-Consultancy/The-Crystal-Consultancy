...
if(isset($_POST['post'])){
   ...
   if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Get the description input from the form
    $description = $_POST["description"];
   ...
   if($image_01_size > 2000000000){
      ...
      $insert_property = $conn->prepare("INSERT INTO `property`(id, admin_id, property_name, address, price, type, offer, status, furnished, bhk, deposite, bedroom, bathroom, balcony, carpet, age, total_floors, room_floor, loan, lift, security_guard, play_ground, garden, water_supply, power_backup, parking_area, gym, shopping_mall, hospital, school, market_area, image_01, image_02, image_03, image_04, image_05, description) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"); 
   ...
   <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex">
         <div class="box">
            ...
            <input type="text" name="price" required min="0" max="9999999999" maxlength="10" placeholder="enter property price" class="input">
         </div>
         <div class="box">
            <p>Deposite Amount <span>*</span></p>
            <input type="text" name="deposite" required min="0" max="9999999999" maxlength="10" placeholder="enter deposite amount" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <option value="-" >0 Bed DD</option>
               ...
               <option value="6">6 Bed DD</option>
               <option value="7">7 Bed DD</option>
               <option value="8">8 Bed DD</option>
               <option value="9">9 Bed DD</option>
            </select>
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <option value="-" selected>0 bathroom</option>
         ...
         <div class="box">
            ...
            <select name="balcony" id="balcony" required class="input">
               <option value="-" selected>0 balcony</option>
         ...
         <div class="box">
            ...
            <input type="text" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="how many squarefits?" class="input">
         </div>
         <div class="box">
