<header class="header">
   ...
   <nav class="navbar">
      ...
      <a href="../post_property.php"><i class="fas fa-message"></i><span>Post Property</span></a>
   </nav>
   ...
   <a href="../components/admin_logout.php" onclick="return confirm('logout from this website?');" class="delete-btn"><i class="fas fa-right-from-bracket"></i><span>Iogout</span></a>
